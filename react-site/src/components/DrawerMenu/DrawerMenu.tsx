...
const DrawerMenu = () => {
  ...
  const [settings] = useState({
    language: {
      name: "components.DrawerMenu.title2",
      label: "Language",
      value: ["en", "ru"],
      icon: [
        <LanguageIcon
    ...
    theme: {
      name: "components.DrawerMenu.title3",
      label: "Theme",
      value: ["light", "dark"],
      icon: [
        <LightModeIcon
    ...
    platform: {
      name: "components.DrawerMenu.title4",
      label: "Platform",
      value: ["react", "vue"],
      icon: [
        <Icon
      ...
      <List>
        <ListItem>
          <Typography
            ...
            width="100%"
          >
            {t("components.DrawerMenu.title1")}
          </Typography>
          <IconButton
